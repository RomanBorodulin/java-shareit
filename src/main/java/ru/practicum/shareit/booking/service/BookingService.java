...
public interface BookingService {
    ...
    List<BookingResponseDto> findAllBookingByUserIdAndState(Long userId, String state);

    List<BookingResponseDto> findAllBookingByOwnerIdAndState(Long ownerId, String state);
}
